...
SWIFT_MODULE_NAMESPACE_PUSH("Touchpoint")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC10Touchpoint11AppDelegate")
...
SWIFT_CLASS("_TtC10Touchpoint14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(Touchpoint)) <WKNavigationDelegate, WKUIDelegate>
